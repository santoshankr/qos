...
tc class add dev br-lan parent 1:1 classid 1:2 htb rate ${BW_1}kbit burst 0
tc class add dev br-lan parent 1:1 classid 1:3 htb rate ${BW_2}kbit burst 0
...
tc filter add dev br-lan protocol ip parent 1:0 prio 0 u32 match ip dst $CL_IP_2 flowid 1:3